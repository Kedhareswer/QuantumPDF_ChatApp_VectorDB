...
export async function loadPdfJs() {
  ...
  try {
    ...
    const pdfWorkerSrc = `//cdnjs.cloudflare.com/ajax/libs/pdf.js/${pdfjsModule.version}/pdf.worker.min.js`;
    pdfjsModule.GlobalWorkerOptions.workerSrc = pdfWorkerSrc;
    
    console.log(`PDF.js loaded successfully (version: ${pdfjsModule.version})`);
    return pdfjs;
  } catch (err) {
